			...
			for (int i = 0; i < MarvinSemAnnotator.words.size(); i++) {
				...
				for (int j = 0; j < MarvinSemAnnotator.words.get(i).wordmeanings.size(); j++) {
					System.out.println("Meaninig ("
							+ MarvinSemAnnotator.words.get(i).wordmeanings.get(j).AnnotatorSystem + ")["+MarvinSemAnnotator.words.get(i).wordmeanings.get(j).startAt+":"+MarvinSemAnnotator.words.get(i).wordmeanings.get(j).endAt+"]: "+MarvinSemAnnotator.words.get(i).wordmeanings.get(j).id+"   "
